...
def depth_2_color_space(kinect, depth_space_point, depth_frame_data, show=False, return_aligned_image=False):
    ...
    if return_aligned_image:
        return align_depth_img #shape=(1080,1920)的深度图，对齐到了彩色空间
    return depthXs, depthYs #depthXs和depthYs的shape都是(1080,1920)，保存了color_img里每个像素在depth_img中对应像素的x和y坐标
